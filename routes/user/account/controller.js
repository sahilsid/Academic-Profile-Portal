...
router.post('/resendVerificationLink', (req, res, next) => {
    verification.sendVerificationLink(req, res, next);
});


router.get('/verify/:userId', (req, res, next) => {
    verification.verifyLink(req, res, next);
});
...
router.post('/sendotp', (req, res, next) => {
    verification.sendotp(req, res, next);
});

router.post('/verifyotp', (req, res, next) => {
    verification.verifyotp(req, res, next);
});
